...
<video width="320" height="240" controls="controls">
  <source src="http://www.nikhilvermaphotohub.com/first/videouploads/'.$video_id.'.'.$ext.'" type="video/'.$ext.'">
  <object data="http://www.nikhilvermaphotohub.com/first/videouploads/'.$video_id.'.'.$ext.'" width="320" height="240">
    <embed src="http://www.nikhilvermaphotohub.com/first/videouploads/'.$video_id.'.'.$ext.'" width="320" height="240">
  </object> 
</video>';
