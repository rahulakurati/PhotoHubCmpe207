...
$url = "http://jamp4793.com/cmpe207/somefile.php";
	...
	//echo $num;
	 //echo "<br/>";
	 $c=1;
$string = "http://jamp4793.com/cmpe207/pictures1/";
...
mysql_query("INSERT INTO anusha VALUES('', '$m')");
...
header('Location: http://www.nikhilvermaphotohub.com/first/crossdomain.php');
exit();
?>